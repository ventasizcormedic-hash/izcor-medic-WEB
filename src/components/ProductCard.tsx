...
export function ProductCard({
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[4/3] bg-white flex items-center justify-center overflow-hidden border-b border-slate-100/80">
        {/* Subtle radial glow effect in background */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_rgba(0,0,0,0.02)_0%,_transparent_70%)] pointer-events-none" />
        <Link 
          to={`/productos/${slug}`}
